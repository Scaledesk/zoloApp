appControllers.controller('packagesListCtrl', function ($scope, $timeout, $mdUtil,packagesService,$ionicModal,algolia,
                                                       $mdSidenav, $log, $ionicHistory, $state,$stateParams,MaxPriceService) {
    ...
    $ionicModal.fromTemplateUrl('templates/category/html/search_package_modal.html', {
        scope: $scope,
