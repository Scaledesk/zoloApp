appControllers.controller('productDesCtrl', function ($scope, $timeout, $mdUtil,productService,
    ...
    productService.getProductDescription($stateParams.des_product_id).then(function(data){
