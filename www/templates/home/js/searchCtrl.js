   ...
   $scope.search_package = function (text) {
    ...
    $scope.search_result = function(text){
        if(text){
            ...
            else if(window.localStorage['text_1'] && window.localStorage['text_2'] && window.localStorage['text_3'] && count == 3){
                window.localStorage['text_1']=text;
                count = 2;
                console.log("inside if 4");
            }
            else if(window.localStorage['text_1'] && window.localStorage['text_2'] && window.localStorage['text_3'] && count == 2){
                window.localStorage['text_2']=text;
                count = 1;
                console.log("inside if 5");
            }
            else if(window.localStorage['text_1'] && window.localStorage['text_2'] && window.localStorage['text_3'] && count == 1){
                window.localStorage['text_3']=text;
                count = 0;
                console.log("inside if 6");
            }
            else if(window.localStorage['text_1'] && window.localStorage['text_2'] && window.localStorage['text_3'] && count == 0){
                window.localStorage['text_1']=text;
                count = 1;
